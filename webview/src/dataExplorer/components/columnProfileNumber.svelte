<!--
  columnProfileNumber.svelte - Expanded number profile
  Port from Positron's columnProfileNumber.tsx
-->
<script lang="ts">
...
<div class="column-profile-expanded column-profile-info">
    ...
    <div class="tabular-info">
        ...
        <div class="values">
            ...
            <StatsValue {stats} value={stats?.min_value} />
            <StatsValue {stats} value={stats?.median} />
            <StatsValue {stats} value={stats?.mean} />
            <StatsValue {stats} value={stats?.max_value} />
