...
<script lang="ts">
    ...
    import type { RowFilterDescriptor } from "../../addEditRowFilterModalPopup/rowFilterDescriptor";
    import {
    ...
    const { tableDataDataGridInstance } = getDataExplorerContext();
...
<div
    ...
    tabindex={onEdit ? 0 : -1}
    title={tableDataDataGridInstance?.hoverManager ? undefined : widgetTooltip}
>
    <div class="title">
    ...
    <button
        ...
        title={tableDataDataGridInstance?.hoverManager ? undefined : clearTooltip}
        type="button"
    >
