...
<script lang="ts">
    ...
    import RowFilterWidget from "./RowFilterWidget.svelte";
    import AddEditRowFilterModal from "./AddEditRowFilterModal.svelte";
    import {
    ...
    const { stores, postMessage, gridInstance, invalidateTableData } =
...
<div class="row-filter-bar" class:has-filters={hasFilters}>
    <button
        ...
        onblur={hideHover}
        title={gridInstance?.hoverManager
            ? undefined
            : localize("positron.manageFilters", "Manage Filters")}
