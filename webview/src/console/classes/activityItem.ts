...
/**
 * ActivityItem class - Abstract base class for activity items within a RuntimeItemActivity.
 * Mirrors: positron/src/vs/workbench/services/positronConsole/browser/classes/activityItem.ts
 */
