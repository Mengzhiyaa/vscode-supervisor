 ...
 * Represents text/plain output with ANSI formatting from a language runtime.
 * Mirrors: positron/src/vs/workbench/services/positronConsole/browser/classes/activityItemOutputMessage.ts
 */
