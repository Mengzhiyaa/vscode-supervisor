/*---------------------------------------------------------------------------------------------
 *  Data Explorer Custom Editor Provider
...
import { IDataExplorerService } from './dataExplorerService';
import { DataExplorerEditorProvider } from './dataExplorerEditorProvider';

/**
 * A lightweight CustomReadonlyEditorProvider that delegates to the existing
 * DataExplorerEditorProvider for all panel lifecycle management.
 *
...
export class DataExplorerCustomEditorProvider implements vscode.CustomReadonlyEditorProvider {
    ...
    constructor(
        ...
        private readonly _editorProvider: DataExplorerEditorProvider,
    ...
    async resolveCustomEditor(
        ...
        try {
            ...
            // Mark this identifier so the DataExplorerEditorProvider's onDidCreateInstance
