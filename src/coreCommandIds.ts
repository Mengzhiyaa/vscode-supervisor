export const CoreCommandIds = {
    ...
    variablesFocus: 'supervisor.variables.focus',
    variablesExpand: 'supervisor.variables.expand',
    variablesCollapse: 'supervisor.variables.collapse',
    variablesCopyAsText: 'supervisor.variables.copyAsText',
    variablesCopyAsHtml: 'supervisor.variables.copyAsHtml',
...
export const ContextKeys = {
    ...
    variablesFocused: 'supervisor.variablesFocused',
    variablesHasSelection: 'supervisor.variablesHasSelection',
